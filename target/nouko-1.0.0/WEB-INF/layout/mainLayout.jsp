...
<%-- 	
		<spring:url value="/resources/css/bootstrapnav.css" 	var="bootstrapnavCss" />
		<link href="${bootstrapnavCss}" rel="stylesheet" />
--%>	
...
<%-- 	
  <script src="//code.jquery.com/jquery-1.10.2.js"></script>
		<spring:url value="/resources/javascript/jquery-ui.min.js"  var="jqueryuiJs" />
...
<%-- 	
		<table   class="mainLayoutTable">	
			...
			<tr height="85%">
				<td width="20%" valign="top"><tiles:insertAttribute name="menu" /></td>
